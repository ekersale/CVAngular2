...
export const LANG_FR_TRANS = {
  ...
  'LifeDetails'       : "Je suis né en France en 1994, début de l'ère informatisée. Dès le plus jeune âge, entouré quotidiennement par ces nouvelles technologie, j'ai développé une certaine capacité à comprendre les systèmes par moi même. Un certain nombre d'années plus tard quand le choix d'étude est intervenu il était telle une évidence que je m'engage vers le développpement informatique. Commençant par le développement logiciel je me suis par la suite intéressé au domaine du web et à ses avantages non négligeables.",
  "What am I looking for ?" : "Qu'est-ce que je recherche",
  'WhatIWantDetails'  : "Je débute actuellement ma carrière en développement d'applications web et standalone. Je suis à l'écoute du marché et même en recherche d'une opportunité à l'international. Durant mes précédentes expériences j'ai su démontrer ma motivation et mon autonomie à réaliser mes buts.",
  'Frontend'          : 'Frontal',
  'System'            : 'Système',
  'Tools'             : 'Outils',
  'Backend'           : 'Arrière',
